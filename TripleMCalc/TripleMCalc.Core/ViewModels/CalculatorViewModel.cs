    ...
    public class CalculatorViewModel : MvxViewModel
    {
       ...
       private string _responseText; //get and set the response text
        ...
        async Task Recalculate()
        {
            ...
            if (await WasItemPurchased("subscriptionmeanmediananswers"))//do these calculations if they have been paid for
            {
        ...
        {
            //await MakePurchase("meanmediananswers");//this is the product ID for the managed Product
            await MakePurchase("subscriptionmeanmediananswers");//this is the product ID for the subscription product 
            // responseText="Hello";
        }
        ...
        public async Task CheckPurchase()
        {
            ...
            await WasItemPurchased("subscriptionmeanmediananswers");
        ...
        
        {
            ...
            //var productIds = "meanmediananswers"; 
                try
                {
                    ...
                    bool connected = await billing.ConnectAsync(ItemType.Subscription); //ConnectAsync ensures a valid connecion to the app store
                ...
                IEnumerable<InAppBillingPurchase> purchased = await billing.GetPurchasesAsync(ItemType.Subscription);
                ...
                foreach (InAppBillingProduct item in items)
                    ...
                    InAppBillingPurchase purchase = await billing.PurchaseAsync(productID, ItemType.Subscription, "devId");
                    if (purchase == null)
                        {
